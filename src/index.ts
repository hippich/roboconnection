...
import { JiboConnection, ConnectionInfo, RobotInfo } from './connection/JiboConnection';
...
// JIBO declarations are here to ensure they are included in the generated dist/index.d.ts
declare global {
    ...
    namespace JIBO {
        ...
        export namespace v1 {
            ...
            export namespace Commands {
                ...
                export type VideoPlayback = 'VideoPlayback';
                export type CommandType = StartSession | GetConfig | SetConfig | Cancel | Display | SetAttention | Say | Listen | LookAt |
                    TakePhoto | StorePhoto | Video | Subscribe | FetchAsset | SkillAction | UnloadAsset | VideoPlayback;
            }
             ...
             * play a video
             */
            export interface VideoPlaybackRequest extends BaseCommand {
            ...
            export type RobotCommands = GetConfigRequest | AttentionRequest | SayRequest | ListenRequest | LookAtRequest |
                ...
                MotionRequest | AudioRequest | SetConfigRequest | HeadTouchRequest | FetchAssetRequest | SkillActionRequest | UnloadAssetRequest | VideoPlaybackRequest;
